...
- **2025-10-26:** 📋 **Добавлена задача CQST-002: Переход на авторизацию через username + password**
  - Создан детальный план реализации (5 этапов)
  - Определен Level 2 - Simple Enhancement
  - Оценка времени: 1-2 часа
  - Затрагивает: security.yaml, User.php, JWT config, тесты
  - Статус: ПЛАНИРОВАНИЕ
- **2025-10-26:** 🐛 **Исправлена ошибка "Expired JWT Token" при регистрации**
  - Добавлен отдельный firewall api_public для /api/auth/(register|logout)
  - Упрощены access_control правила
  - Регистрация теперь работает корректно без требования JWT токена
