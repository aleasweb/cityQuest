...
class UserProgressServiceTest extends TestCase
{
    ...
    private QuestStepRepositoryInterface $questStepRepository;
    ...
    protected function setUp(): void
    {
        ...
        $this->questStepRepository = $this->createMock(QuestStepRepositoryInterface::class);
    ...
    public function testStartQuestCreatesNewProgress(): void
    {
        ...
        $firstStep = clone $quest; // Dummy step, but wait I need actual QuestStep
        ...
        $step = new \App\Quest\Domain\Entity\QuestStep($questId, 1, 55.0, 37.0, 50);
        $this->questStepRepository->method('findFirstActiveByQuest')->willReturn($step);
